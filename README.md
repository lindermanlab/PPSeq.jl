...
> **[Alex H. Williams](alexhwilliams.info), Anthony Degleris, Yixin Wang, [Scott W. Linderman](https://web.stanford.edu/~swl1/).**  Point process models for sequence detection in high-dimensional neural spike trains. *NeurIPS 2020*, Vancouver, CA.
